            ...
            <div class="form-container">
                <form id="formGateway" method="post" action="" class="no-gutter">
                    ...
                    <fieldset class="form-left col-md-7">
                        ...
                        <p>
                            <input type="text" name="name" placeholder="<?= $dictionary["name"]; ?>" class="field field-1" required />
                            <input type="text" name="lastName" placeholder="<?= $dictionary["lastName"]; ?>" class="field field-2" required />
                        </p>
                        <p>
                            <input type="email" name="email" placeholder="<?= $dictionary["email"]; ?>" class="field field-3" required/>
                        ...
                        <!--p>
                            ...
                            <input type="text" name="documentNumber" placeholder="Número de documento" class="field number field-6" required/>
                        </p-->
                        <p>
                    ...
                    <fieldset class="form-right col-md-5">
                        ...
                        <p class="logo-field">
                            ...
                            <select class="field" name="cardType" required aria-invalid="false">
                        ...
                        <p>
                            ...
                            <input type="text" class="field number creditCard" name="cardNumber" required size="17" maxlength="16" autocomplete="off" <?= Configuration::PRODUCTION ? 'onpaste="return false;"' : ''; ?> >
                        </p>

                        <p>
                            <strong><?= $dictionary["cardHolder"]; ?></strong>
                            <input type="text" class="field" name="cardOwner" required>
                        </p>
                        ...
                        <p>
                            <strong><?= $dictionary["feesNumber"]; ?></strong>
                            <select class="field field-sm valid" name="creditDues" aria-invalid="false" required>
